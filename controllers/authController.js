...
// This is used to sign the JWT token that is sent to the user upon login
const signToken = (id) => {
...
// This is used to create a cookie that is sent to the user upon login
...
// This is used to restrict access to certain routes based on user role
...
// This is used to update a user's password
